...
public final class ExpressionEditor {
    ...
    public void render(GuiGraphicsExtractor g, int mouseX, int mouseY, float pt) {
        ...
        g.text(font, legend1, px + 8, py + 78, 0xFFB9C6FF, false);
        g.text(font, legend2, px + 8, py + 90, 0xFFB9C6FF, false);
        String help2 = "press Tab to autocomplete";
        g.text(font, help1, px + W - 8 - font.width(help1), py + 104, 0xFF9AD49A, false);
        g.text(font, help2, px + W - 8 - font.width(help2), py + 116, 0xFF9AD49A, false);
