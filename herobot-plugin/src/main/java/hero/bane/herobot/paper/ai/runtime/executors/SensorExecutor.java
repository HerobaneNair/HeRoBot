...
import hero.bane.herobot.common.ai.block.ItemSlots;
...
import hero.bane.herobot.paper.util.DistanceCalculator;
...
public final class SensorExecutor {
    ...
    public static void register(Map<BlockType, Reporter> reporter) {
        ...
        reporter.put(BlockType.IN_PATH, (b, r, br) -> {
            ...
            return hero.bane.herobot.paper.control.RemotePathState.isActive(r.player());
        });
